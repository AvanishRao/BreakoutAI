...
class DataHandler:
    ...
    def connect_google_sheet(self, sheet_url: str, sheets_creds_file: str) -> pd.DataFrame:
    ...
    def validate_sheets_credentials(self, sheets_creds_file: str) -> bool:
    ...
    def check_sheets_access(self, sheets_creds_file: str) -> bool:
        """Check if we have valid access to Google Sheets API."""
        try:
            if not self.validate_sheets_credentials(sheets_creds_file):
